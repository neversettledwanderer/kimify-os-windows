...
Analyze and produce a comprehensive diversification analysis that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing diversification analysis documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the diversification analysis
...
- Structure the diversification analysis using the output format below
