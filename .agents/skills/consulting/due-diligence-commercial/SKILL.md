...
Create a comprehensive due diligence commercial that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing due diligence commercial documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the due diligence commercial
...
- Structure the due diligence commercial using the output format below
