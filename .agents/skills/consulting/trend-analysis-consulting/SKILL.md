...
Analyze and produce a comprehensive trend analysis consulting that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing trend analysis consulting documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the trend analysis consulting
...
- Structure the trend analysis consulting using the output format below
