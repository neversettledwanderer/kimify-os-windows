...
Design and document a comprehensive 100 day plan that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing 100 day plan documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the 100 day plan
...
- Structure the 100 day plan using the output format below
