...
Analyze and produce a comprehensive pestel analysis that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing pestel analysis documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the pestel analysis
...
- Structure the pestel analysis using the output format below
