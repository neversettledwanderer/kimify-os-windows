...
Analyze and produce a comprehensive value chain analysis that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing value chain analysis documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the value chain analysis
...
- Structure the value chain analysis using the output format below
