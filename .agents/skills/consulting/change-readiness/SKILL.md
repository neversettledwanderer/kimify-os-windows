...
Create a comprehensive change readiness that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing change readiness documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the change readiness
...
- Structure the change readiness using the output format below
