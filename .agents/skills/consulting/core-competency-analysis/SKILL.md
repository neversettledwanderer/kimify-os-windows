...
Analyze and produce a comprehensive core competency analysis that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing core competency analysis documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the core competency analysis
...
- Structure the core competency analysis using the output format below
