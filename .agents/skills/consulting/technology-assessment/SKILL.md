...
Analyze and produce a comprehensive technology assessment that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing technology assessment documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the technology assessment
...
- Structure the technology assessment using the output format below
