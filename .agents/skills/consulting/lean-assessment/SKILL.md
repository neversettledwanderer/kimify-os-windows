...
Analyze and produce a comprehensive lean assessment that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing lean assessment documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the lean assessment
...
- Structure the lean assessment using the output format below
