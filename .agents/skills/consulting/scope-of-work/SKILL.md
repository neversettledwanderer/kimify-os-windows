...
Create a comprehensive scope of work that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing scope of work documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the scope of work
...
- Structure the scope of work using the output format below
