...
Analyze and produce a comprehensive current state assessment that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing current state assessment documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the current state assessment
...
- Structure the current state assessment using the output format below
