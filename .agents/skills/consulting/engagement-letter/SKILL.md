...
Create a comprehensive engagement letter that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing engagement letter documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the engagement letter
...
- Structure the engagement letter using the output format below
