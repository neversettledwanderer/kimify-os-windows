...
Analyze and produce a comprehensive swot analysis that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing swot analysis documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the swot analysis
...
- Structure the swot analysis using the output format below
