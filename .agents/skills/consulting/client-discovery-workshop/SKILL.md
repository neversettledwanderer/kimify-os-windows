...
Create a comprehensive client discovery workshop that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing client discovery workshop documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the client discovery workshop
...
- Structure the client discovery workshop using the output format below
