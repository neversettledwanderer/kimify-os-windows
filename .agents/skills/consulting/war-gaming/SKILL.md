...
Create a comprehensive war gaming that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing war gaming documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the war gaming
...
- Structure the war gaming using the output format below
