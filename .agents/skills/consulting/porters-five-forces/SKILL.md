...
Create a comprehensive porters five forces that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing porters five forces documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the porters five forces
...
- Structure the porters five forces using the output format below
