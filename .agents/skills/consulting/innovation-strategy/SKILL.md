...
Design and document a comprehensive innovation strategy that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing innovation strategy documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the innovation strategy
...
- Structure the innovation strategy using the output format below
