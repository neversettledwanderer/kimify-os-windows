...
Design and document a comprehensive strategy framework that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing strategy framework documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the strategy framework
...
- Structure the strategy framework using the output format below
