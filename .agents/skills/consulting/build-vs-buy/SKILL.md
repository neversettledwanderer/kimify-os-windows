...
Create a comprehensive build vs buy that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing build vs buy documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the build vs buy
...
- Structure the build vs buy using the output format below
