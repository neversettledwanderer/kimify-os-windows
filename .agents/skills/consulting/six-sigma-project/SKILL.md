...
Create a comprehensive six sigma project that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing six sigma project documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the six sigma project
...
- Structure the six sigma project using the output format below
