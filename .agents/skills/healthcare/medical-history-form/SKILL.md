---
description: Create a medical history form with structured process, quality checks, and system integration
---
...
Create a comprehensive medical history form that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing medical history form documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the medical history form
...
- Structure the medical history form using the output format below
