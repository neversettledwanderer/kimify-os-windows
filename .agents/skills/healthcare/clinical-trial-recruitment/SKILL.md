---
description: Create a clinical trial recruitment with structured process, quality checks, and system integration
---
...
Create a comprehensive clinical trial recruitment that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing clinical trial recruitment documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the clinical trial recruitment
...
- Structure the clinical trial recruitment using the output format below
