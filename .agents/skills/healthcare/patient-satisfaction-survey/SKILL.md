---
description: Create a patient satisfaction survey with structured process, quality checks, and system integration
---
...
Create a comprehensive patient satisfaction survey that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing patient satisfaction survey documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Structure the patient satisfaction survey using the output format below
