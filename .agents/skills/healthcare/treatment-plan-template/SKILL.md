---
description: Create a treatment plan template with structured process, quality checks, and system integration
---
...
Create a comprehensive treatment plan template that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing treatment plan template documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the treatment plan template
...
- Structure the treatment plan template using the output format below
