---
description: Create a health content article with structured process, quality checks, and system integration
---
...
Create a comprehensive health content article that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing health content article documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the health content article
...
- Structure the health content article using the output format below
