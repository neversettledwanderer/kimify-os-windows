---
description: Create a research protocol summary with structured process, quality checks, and system integration
---
...
Create a comprehensive research protocol summary that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing research protocol summary documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the research protocol summary
...
- Structure the research protocol summary using the output format below
