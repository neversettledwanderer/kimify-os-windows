---
description: Design and document a telehealth setup with structured process, quality checks, and system integration
---
...
Design and document a comprehensive telehealth setup that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing telehealth setup documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the telehealth setup
...
- Structure the telehealth setup using the output format below
