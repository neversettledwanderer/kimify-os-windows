---
description: Create a discharge instructions with structured process, quality checks, and system integration
---
...
Create a comprehensive discharge instructions that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing discharge instructions documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the discharge instructions
...
- Structure the discharge instructions using the output format below
