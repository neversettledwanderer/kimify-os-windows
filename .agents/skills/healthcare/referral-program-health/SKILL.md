---
description: Design and document a referral program health with structured process, quality checks, and system integration
---
...
Design and document a comprehensive referral program health that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing referral program health documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the referral program health
...
- Structure the referral program health using the output format below
