---
description: Create a appointment reminder with structured process, quality checks, and system integration
---
...
Create a comprehensive appointment reminder that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing appointment reminder documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the appointment reminder
...
- Structure the appointment reminder using the output format below
