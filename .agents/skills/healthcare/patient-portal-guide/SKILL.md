---
description: Design and document a patient portal guide with structured process, quality checks, and system integration
---
...
Design and document a comprehensive patient portal guide that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing patient portal guide documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the patient portal guide
...
- Structure the patient portal guide using the output format below
