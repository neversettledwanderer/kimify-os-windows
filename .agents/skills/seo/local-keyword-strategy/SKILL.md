---
description: Design and document a local keyword strategy with structured process, quality checks, and system integration
---
...
Design and document a comprehensive local keyword strategy that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing local keyword strategy documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the local keyword strategy
...
- Structure the local keyword strategy using the output format below
