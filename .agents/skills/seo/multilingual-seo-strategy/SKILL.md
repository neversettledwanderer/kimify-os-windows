---
description: Design and document a multilingual seo strategy with structured process, quality checks, and system integration
---
...
Design and document a comprehensive multilingual seo strategy that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing multilingual seo strategy documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the multilingual seo strategy
...
- Structure the multilingual seo strategy using the output format below
