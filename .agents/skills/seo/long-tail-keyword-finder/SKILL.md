---
description: Create a long tail keyword finder with structured process, quality checks, and system integration
---
...
Create a comprehensive long tail keyword finder that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing long tail keyword finder documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the long tail keyword finder
...
- Structure the long tail keyword finder using the output format below
