---
description: Create a image alt text optimization with structured process, quality checks, and system integration
---
...
Create a comprehensive image alt text optimization that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing image alt text optimization documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the image alt text optimization
...
- Structure the image alt text optimization using the output format below
