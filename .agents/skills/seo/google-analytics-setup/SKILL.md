---
description: Design and document a google analytics setup with structured process, quality checks, and system integration
---
...
Design and document a comprehensive google analytics setup that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing google analytics setup documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the google analytics setup
...
- Structure the google analytics setup using the output format below
