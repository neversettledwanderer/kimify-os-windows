---
description: Create a keyword research with structured process, quality checks, and system integration
---
...
Create a comprehensive keyword research that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing keyword research documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the keyword research
...
- Structure the keyword research using the output format below
