---
description: Analyze and produce a technical seo audit with structured process, quality checks, and system integration
---
...
Analyze and produce a comprehensive technical seo audit that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing technical seo audit documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the technical seo audit
...
- Structure the technical seo audit using the output format below
