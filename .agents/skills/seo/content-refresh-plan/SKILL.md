---
description: Design and document a content refresh plan with structured process, quality checks, and system integration
---
...
Design and document a comprehensive content refresh plan that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing content refresh plan documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the content refresh plan
...
- Structure the content refresh plan using the output format below
