---
description: Create a schema markup generator with structured process, quality checks, and system integration
---
...
Create a comprehensive schema markup generator that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing schema markup generator documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the schema markup generator
...
- Structure the schema markup generator using the output format below
