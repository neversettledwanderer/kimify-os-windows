---
description: Create a broken link building with structured process, quality checks, and system integration
---
...
Create a comprehensive broken link building that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing broken link building documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the broken link building
...
- Structure the broken link building using the output format below
