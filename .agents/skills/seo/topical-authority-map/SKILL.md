---
description: Create a topical authority map with structured process, quality checks, and system integration
---
...
Create a comprehensive topical authority map that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing topical authority map documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the topical authority map
...
- Structure the topical authority map using the output format below
