---
description: Create a header tag optimization with structured process, quality checks, and system integration
---
...
Create a comprehensive header tag optimization that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing header tag optimization documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the header tag optimization
...
- Structure the header tag optimization using the output format below
