---
description: Create a partnership agreement with structured process, quality checks, and system integration
---
...
Create a comprehensive partnership agreement that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing partnership agreement documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the partnership agreement
...
- Structure the partnership agreement using the output format below
