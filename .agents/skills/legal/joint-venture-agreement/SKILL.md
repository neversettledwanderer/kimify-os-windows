---
description: Create a joint venture agreement with structured process, quality checks, and system integration
---
...
Create a comprehensive joint venture agreement that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing joint venture agreement documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the joint venture agreement
...
- Structure the joint venture agreement using the output format below
