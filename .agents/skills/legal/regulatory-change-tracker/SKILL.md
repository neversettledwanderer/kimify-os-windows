---
description: Analyze and produce a regulatory change tracker with structured process, quality checks, and system integration
---
...
Analyze and produce a comprehensive regulatory change tracker that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing regulatory change tracker documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the regulatory change tracker
...
- Structure the regulatory change tracker using the output format below
