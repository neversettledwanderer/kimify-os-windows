---
description: Analyze and produce a risk assessment with structured process, quality checks, and system integration
---
...
Analyze and produce a comprehensive risk assessment that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing risk assessment documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the risk assessment
...
- Structure the risk assessment using the output format below
