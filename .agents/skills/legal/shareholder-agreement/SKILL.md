---
description: Create a shareholder agreement with structured process, quality checks, and system integration
---
...
Create a comprehensive shareholder agreement that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing shareholder agreement documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the shareholder agreement
...
- Structure the shareholder agreement using the output format below
