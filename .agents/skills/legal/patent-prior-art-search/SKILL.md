---
description: Create a patent prior art search with structured process, quality checks, and system integration
---
...
Create a comprehensive patent prior art search that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing patent prior art search documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the patent prior art search
...
- Structure the patent prior art search using the output format below
