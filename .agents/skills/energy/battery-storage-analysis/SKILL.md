---
description: Analyze and produce a battery storage analysis with structured process, quality checks, and system integration
---
...
Analyze and produce a comprehensive battery storage analysis that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing battery storage analysis documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the battery storage analysis
...
- Structure the battery storage analysis using the output format below
