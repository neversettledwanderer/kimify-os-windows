---
description: Create a science based targets with structured process, quality checks, and system integration
---
...
Create a comprehensive science based targets that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing science based targets documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the science based targets
...
- Structure the science based targets using the output format below
