---
description: Design and document a waste management plan with structured process, quality checks, and system integration
---
...
Design and document a comprehensive waste management plan that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing waste management plan documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the waste management plan
...
- Structure the waste management plan using the output format below
