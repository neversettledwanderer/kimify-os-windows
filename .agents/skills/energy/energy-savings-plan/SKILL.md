---
description: Design and document a energy savings plan with structured process, quality checks, and system integration
---
...
Design and document a comprehensive energy savings plan that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing energy savings plan documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the energy savings plan
...
- Structure the energy savings plan using the output format below
