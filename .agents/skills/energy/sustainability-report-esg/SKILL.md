---
description: Analyze and produce a sustainability report esg with structured process, quality checks, and system integration
---
...
Analyze and produce a comprehensive sustainability report esg that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing sustainability report esg documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the sustainability report esg
...
- Structure the sustainability report esg using the output format below
