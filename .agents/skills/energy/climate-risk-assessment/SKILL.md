---
description: Analyze and produce a climate risk assessment with structured process, quality checks, and system integration
---
...
Analyze and produce a comprehensive climate risk assessment that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing climate risk assessment documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the climate risk assessment
...
- Structure the climate risk assessment using the output format below
