---
description: Analyze and produce a circular economy assessment with structured process, quality checks, and system integration
---
...
Analyze and produce a comprehensive circular economy assessment that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing circular economy assessment documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the circular economy assessment
...
- Structure the circular economy assessment using the output format below
