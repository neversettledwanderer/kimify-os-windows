---
description: Design and document a resilience planning with structured process, quality checks, and system integration
---
...
Design and document a comprehensive resilience planning that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing resilience planning documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the resilience planning
...
- Structure the resilience planning using the output format below
