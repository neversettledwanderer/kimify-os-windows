---
description: Create a renewable energy certificate with structured process, quality checks, and system integration
---
...
Create a comprehensive renewable energy certificate that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing renewable energy certificate documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the renewable energy certificate
...
- Structure the renewable energy certificate using the output format below
