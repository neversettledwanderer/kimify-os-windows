---
description: Analyze and produce a renewable energy assessment with structured process, quality checks, and system integration
---
...
Analyze and produce a comprehensive renewable energy assessment that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing renewable energy assessment documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the renewable energy assessment
...
- Structure the renewable energy assessment using the output format below
