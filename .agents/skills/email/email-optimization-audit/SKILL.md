---
description: Analyze and produce a email optimization audit with structured process, quality checks, and system integration
---

# Email Optimization Audit

## Purpose

Analyze and produce a comprehensive email optimization audit that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing email optimization audit documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the email optimization audit
...
- Structure the email optimization audit using the output format below
