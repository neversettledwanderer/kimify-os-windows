---
description: Create a event invitation email with structured process, quality checks, and system integration
---
...
Create a comprehensive event invitation email that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing event invitation email documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the event invitation email
...
- Structure the event invitation email using the output format below
