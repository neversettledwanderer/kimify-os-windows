---
description: Design and document a list cleaning plan with structured process, quality checks, and system integration
---
...
Design and document a comprehensive list cleaning plan that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing list cleaning plan documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the list cleaning plan
...
- Structure the list cleaning plan using the output format below
