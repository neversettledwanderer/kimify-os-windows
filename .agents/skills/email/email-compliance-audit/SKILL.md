---
description: Analyze and produce a email compliance audit with structured process, quality checks, and system integration
---
...
Analyze and produce a comprehensive email compliance audit that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing email compliance audit documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the email compliance audit
...
- Structure the email compliance audit using the output format below
