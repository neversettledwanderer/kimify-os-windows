---
description: Create a browse abandonment sequence with structured process, quality checks, and system integration
---
...
Create a comprehensive browse abandonment sequence that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing browse abandonment sequence documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Structure the browse abandonment sequence using the output format below
