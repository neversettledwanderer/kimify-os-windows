---
description: Analyze and produce a email reporting template with structured process, quality checks, and system integration
---
...
Analyze and produce a comprehensive email reporting template that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing email reporting template documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the email reporting template
...
- Structure the email reporting template using the output format below
