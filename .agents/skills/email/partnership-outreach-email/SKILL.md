---
description: Create a partnership outreach email with structured process, quality checks, and system integration
---
...
Create a comprehensive partnership outreach email that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing partnership outreach email documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Structure the partnership outreach email using the output format below
