---
description: Analyze and produce a email analytics dashboard with structured process, quality checks, and system integration
---
...
Analyze and produce a comprehensive email analytics dashboard that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing email analytics dashboard documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the email analytics dashboard
...
- Structure the email analytics dashboard using the output format below
