---
description: Design and document a email automation workflow with structured process, quality checks, and system integration
---
...
Design and document a comprehensive email automation workflow that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing email automation workflow documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the email automation workflow
...
- Structure the email automation workflow using the output format below
