---
description: Create a transactional email copy with structured process, quality checks, and system integration
---
...
Create a comprehensive transactional email copy that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing transactional email copy documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the transactional email copy
...
- Structure the transactional email copy using the output format below
