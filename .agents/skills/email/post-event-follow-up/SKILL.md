---
description: Create a post event follow up with structured process, quality checks, and system integration
---
...
Create a comprehensive post event follow up that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing post event follow up documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the post event follow up
...
- Structure the post event follow up using the output format below
