---
description: Design and document a lifecycle email strategy with structured process, quality checks, and system integration
---
...
Design and document a comprehensive lifecycle email strategy that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing lifecycle email strategy documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the lifecycle email strategy
...
- Structure the lifecycle email strategy using the output format below
