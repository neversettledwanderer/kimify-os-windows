...
Design and document a comprehensive seasonal planning that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing seasonal planning documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the seasonal planning
...
- Structure the seasonal planning using the output format below
