...
Analyze and produce a comprehensive supplier evaluation that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing supplier evaluation documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the supplier evaluation
...
- Structure the supplier evaluation using the output format below
