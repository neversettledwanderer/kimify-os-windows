...
Create a comprehensive category taxonomy that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing category taxonomy documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the category taxonomy
...
- Structure the category taxonomy using the output format below
