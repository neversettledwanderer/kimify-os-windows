...
Create a comprehensive customer segmentation ecom that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing customer segmentation ecom documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the customer segmentation ecom
...
- Structure the customer segmentation ecom using the output format below
