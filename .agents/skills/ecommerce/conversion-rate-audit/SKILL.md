...
Analyze and produce a comprehensive conversion rate audit that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing conversion rate audit documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the conversion rate audit
...
- Structure the conversion rate audit using the output format below
