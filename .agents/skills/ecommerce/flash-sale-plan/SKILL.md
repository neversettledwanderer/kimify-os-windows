...
Design and document a comprehensive flash sale plan that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing flash sale plan documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the flash sale plan
...
- Structure the flash sale plan using the output format below
