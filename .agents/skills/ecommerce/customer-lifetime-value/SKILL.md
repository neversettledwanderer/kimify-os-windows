...
Create a comprehensive customer lifetime value that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing customer lifetime value documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the customer lifetime value
...
- Structure the customer lifetime value using the output format below
