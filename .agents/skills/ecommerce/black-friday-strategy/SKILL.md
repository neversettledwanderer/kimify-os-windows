...
Design and document a comprehensive black friday strategy that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing black friday strategy documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the black friday strategy
...
- Structure the black friday strategy using the output format below
