...
Create a comprehensive customer acquisition cost that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing customer acquisition cost documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the customer acquisition cost
...
- Structure the customer acquisition cost using the output format below
