...
Design and document a comprehensive bundle strategy that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing bundle strategy documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the bundle strategy
...
- Structure the bundle strategy using the output format below
