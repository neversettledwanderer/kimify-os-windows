...
Create a comprehensive fulfillment optimization that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing fulfillment optimization documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the fulfillment optimization
...
- Structure the fulfillment optimization using the output format below
