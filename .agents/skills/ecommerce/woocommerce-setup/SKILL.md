...
Design and document a comprehensive woocommerce setup that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing woocommerce setup documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the woocommerce setup
...
- Structure the woocommerce setup using the output format below
