...
Design and document a comprehensive push notification strategy that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing push notification strategy documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the push notification strategy
...
- Structure the push notification strategy using the output format below
