...
Create a comprehensive ecommerce analytics that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing ecommerce analytics documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the ecommerce analytics
...
- Structure the ecommerce analytics using the output format below
