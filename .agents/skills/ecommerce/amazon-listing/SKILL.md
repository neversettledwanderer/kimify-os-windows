...
Create a comprehensive amazon listing that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing amazon listing documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the amazon listing
...
- Structure the amazon listing using the output format below
