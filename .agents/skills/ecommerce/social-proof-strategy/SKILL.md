...
Design and document a comprehensive social proof strategy that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing social proof strategy documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the social proof strategy
...
- Structure the social proof strategy using the output format below
