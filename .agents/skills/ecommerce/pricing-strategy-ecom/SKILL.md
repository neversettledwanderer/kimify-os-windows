...
Design and document a comprehensive pricing strategy ecom that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing pricing strategy ecom documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the pricing strategy ecom
...
- Structure the pricing strategy ecom using the output format below
