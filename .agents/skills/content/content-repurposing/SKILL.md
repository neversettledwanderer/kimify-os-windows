...
Create a comprehensive content repurposing that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing content repurposing documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the content repurposing
...
- Structure the content repurposing using the output format below
