...
Create a comprehensive newsletter welcome series that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing newsletter welcome series documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the newsletter welcome series
...
- Structure the newsletter welcome series using the output format below
