...
Create a comprehensive podcast outline that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing podcast outline documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the podcast outline
...
- Structure the podcast outline using the output format below
