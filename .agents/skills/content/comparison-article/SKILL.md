...
Analyze and produce a comprehensive comparison article that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing comparison article documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Structure the comparison article using the output format below
