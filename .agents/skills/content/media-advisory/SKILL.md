...
Create a comprehensive media advisory that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing media advisory documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the media advisory
...
- Structure the media advisory using the output format below
