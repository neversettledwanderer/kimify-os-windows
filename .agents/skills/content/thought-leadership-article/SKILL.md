...
Create a comprehensive thought leadership article that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing thought leadership article documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the thought leadership article
...
- Structure the thought leadership article using the output format below
