...
Design and document a comprehensive blog series plan that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing blog series plan documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the blog series plan
...
- Structure the blog series plan using the output format below
