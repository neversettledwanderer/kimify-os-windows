...
Create a comprehensive ad copy youtube that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing ad copy youtube documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the ad copy youtube
...
- Structure the ad copy youtube using the output format below
