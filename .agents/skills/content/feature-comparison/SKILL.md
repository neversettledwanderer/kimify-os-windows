...
Analyze and produce a comprehensive feature comparison that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing feature comparison documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the feature comparison
...
- Structure the feature comparison using the output format below
