...
Create a comprehensive podcast show notes that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing podcast show notes documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the podcast show notes
...
- Structure the podcast show notes using the output format below
