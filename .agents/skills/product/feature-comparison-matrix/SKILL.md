...
Analyze and produce a comprehensive feature comparison matrix that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing feature comparison matrix documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the feature comparison matrix
...
- Structure the feature comparison matrix using the output format below
