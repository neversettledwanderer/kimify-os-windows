...
Design and document a comprehensive ecosystem map that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing ecosystem map documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the ecosystem map
...
- Structure the ecosystem map using the output format below
