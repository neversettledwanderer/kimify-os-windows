...
Analyze and produce a comprehensive rice scoring that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing rice scoring documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the rice scoring
...
- Structure the rice scoring using the output format below
