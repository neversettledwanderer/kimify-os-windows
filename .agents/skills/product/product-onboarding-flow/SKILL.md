...
Create a comprehensive product onboarding flow that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing product onboarding flow documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the product onboarding flow
...
- Structure the product onboarding flow using the output format below
