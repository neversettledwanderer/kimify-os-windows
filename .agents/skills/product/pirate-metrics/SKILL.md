...
Analyze and produce a comprehensive pirate metrics that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing pirate metrics documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the pirate metrics
...
- Structure the pirate metrics using the output format below
