...
Design and document a comprehensive event tracking plan that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing event tracking plan documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the event tracking plan
...
- Structure the event tracking plan using the output format below
