...
Create a comprehensive job to be done that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing job to be done documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the job to be done
...
- Structure the job to be done using the output format below
