...
Analyze and produce a comprehensive competitive product analysis that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing competitive product analysis documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the competitive product analysis
...
- Structure the competitive product analysis using the output format below
