...
Create a comprehensive stakeholder update that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing stakeholder update documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the stakeholder update
...
- Structure the stakeholder update using the output format below
