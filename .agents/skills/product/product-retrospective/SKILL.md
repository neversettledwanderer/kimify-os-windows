...
Create a comprehensive product retrospective that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing product retrospective documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the product retrospective
...
- Structure the product retrospective using the output format below
