...
Create a comprehensive knowledge base article that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing knowledge base article documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the knowledge base article
...
- Structure the knowledge base article using the output format below
