...
Design and document a comprehensive beta program plan that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing beta program plan documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the beta program plan
...
- Structure the beta program plan using the output format below
