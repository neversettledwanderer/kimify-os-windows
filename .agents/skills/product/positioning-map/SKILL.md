...
Create a comprehensive positioning map that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing positioning map documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the positioning map
...
- Structure the positioning map using the output format below
