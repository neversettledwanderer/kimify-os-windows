...
Design and document a comprehensive deprecation plan that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing deprecation plan documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the deprecation plan
...
- Structure the deprecation plan using the output format below
