...
Analyze and produce a comprehensive product metrics framework that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing product metrics framework documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the product metrics framework
...
- Structure the product metrics framework using the output format below
