...
Create a comprehensive technical debt prioritization that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing technical debt prioritization documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the technical debt prioritization
...
- Structure the technical debt prioritization using the output format below
