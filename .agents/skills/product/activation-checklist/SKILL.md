...
Analyze and produce a comprehensive activation checklist that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing activation checklist documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the activation checklist
...
- Structure the activation checklist using the output format below
