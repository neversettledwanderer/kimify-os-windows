...
Create a comprehensive impact effort matrix that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing impact effort matrix documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the impact effort matrix
...
- Structure the impact effort matrix using the output format below
