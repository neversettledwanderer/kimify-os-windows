...
Create a comprehensive changelog writer that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing changelog writer documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the changelog writer
...
- Structure the changelog writer using the output format below
