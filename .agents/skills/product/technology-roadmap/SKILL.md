...
Design and document a comprehensive technology roadmap that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing technology roadmap documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the technology roadmap
...
- Structure the technology roadmap using the output format below
