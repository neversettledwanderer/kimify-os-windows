...
Design and document a comprehensive kpi framework that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing kpi framework documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the kpi framework
...
- Structure the kpi framework using the output format below
