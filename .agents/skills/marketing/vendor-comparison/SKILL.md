...
Analyze and produce a comprehensive vendor comparison that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing vendor comparison documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the vendor comparison
...
- Structure the vendor comparison using the output format below
