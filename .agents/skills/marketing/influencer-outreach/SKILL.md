...
Create a comprehensive influencer outreach that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing influencer outreach documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the influencer outreach
...
- Structure the influencer outreach using the output format below
