...
Create a comprehensive multi market launch that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing multi market launch documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the multi market launch
...
- Structure the multi market launch using the output format below
