...
Design and document a comprehensive campaign retrospective that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing campaign retrospective documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the campaign retrospective
...
- Structure the campaign retrospective using the output format below
