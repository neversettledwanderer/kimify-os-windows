...
Design and document a comprehensive back to school campaign that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing back to school campaign documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the back to school campaign
...
- Structure the back to school campaign using the output format below
