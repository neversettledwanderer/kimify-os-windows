...
Design and document a comprehensive thought leadership plan that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing thought leadership plan documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the thought leadership plan
...
- Structure the thought leadership plan using the output format below
