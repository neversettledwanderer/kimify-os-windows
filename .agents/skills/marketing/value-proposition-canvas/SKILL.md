...
Create a comprehensive value proposition canvas that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing value proposition canvas documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the value proposition canvas
...
- Structure the value proposition canvas using the output format below
