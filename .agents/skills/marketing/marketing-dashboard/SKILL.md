...
Analyze and produce a comprehensive marketing dashboard that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing marketing dashboard documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the marketing dashboard
...
- Structure the marketing dashboard using the output format below
