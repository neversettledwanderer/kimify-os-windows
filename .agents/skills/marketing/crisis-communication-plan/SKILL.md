...
Design and document a comprehensive crisis communication plan that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing crisis communication plan documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the crisis communication plan
...
- Structure the crisis communication plan using the output format below
