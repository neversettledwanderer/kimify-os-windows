...
Analyze and produce a comprehensive conversion funnel analysis that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing conversion funnel analysis documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the conversion funnel analysis
...
- Structure the conversion funnel analysis using the output format below
