...
Create a comprehensive channel mix optimization that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing channel mix optimization documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the channel mix optimization
...
- Structure the channel mix optimization using the output format below
