...
Design and document a comprehensive brand guidelines that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing brand guidelines documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the brand guidelines
...
- Structure the brand guidelines using the output format below
