...
Create a comprehensive sponsorship proposal that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing sponsorship proposal documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the sponsorship proposal
...
- Structure the sponsorship proposal using the output format below
