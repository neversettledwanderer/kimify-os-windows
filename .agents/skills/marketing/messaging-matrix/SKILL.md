...
Create a comprehensive messaging matrix that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing messaging matrix documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the messaging matrix
...
- Structure the messaging matrix using the output format below
