...
Create a comprehensive tagline generator that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing tagline generator documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the tagline generator
...
- Structure the tagline generator using the output format below
