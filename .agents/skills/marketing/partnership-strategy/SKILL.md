...
Design and document a comprehensive partnership strategy that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing partnership strategy documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the partnership strategy
...
- Structure the partnership strategy using the output format below
