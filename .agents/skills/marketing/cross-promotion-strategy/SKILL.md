...
Design and document a comprehensive cross promotion strategy that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing cross promotion strategy documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the cross promotion strategy
...
- Structure the cross promotion strategy using the output format below
