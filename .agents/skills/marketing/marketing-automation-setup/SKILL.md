...
Design and document a comprehensive marketing automation setup that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing marketing automation setup documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the marketing automation setup
...
- Structure the marketing automation setup using the output format below
