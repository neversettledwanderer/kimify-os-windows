...
Create a comprehensive audience segmentation that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing audience segmentation documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the audience segmentation
...
- Structure the audience segmentation using the output format below
