...
Create a comprehensive growth experiment that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing growth experiment documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the growth experiment
...
- Structure the growth experiment using the output format below
