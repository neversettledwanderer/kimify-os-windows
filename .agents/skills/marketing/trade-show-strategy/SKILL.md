...
Design and document a comprehensive trade show strategy that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing trade show strategy documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the trade show strategy
...
- Structure the trade show strategy using the output format below
