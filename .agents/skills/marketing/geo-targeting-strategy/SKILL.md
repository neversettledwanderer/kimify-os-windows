...
Design and document a comprehensive geo targeting strategy that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing geo targeting strategy documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the geo targeting strategy
...
- Structure the geo targeting strategy using the output format below
