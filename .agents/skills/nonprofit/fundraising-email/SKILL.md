---
description: Create a fundraising email with structured process, quality checks, and system integration
---
...
Create a comprehensive fundraising email that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing fundraising email documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the fundraising email
...
- Structure the fundraising email using the output format below
