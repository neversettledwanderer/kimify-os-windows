---
description: Create a grassroots mobilization with structured process, quality checks, and system integration
---
...
Create a comprehensive grassroots mobilization that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing grassroots mobilization documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the grassroots mobilization
...
- Structure the grassroots mobilization using the output format below
