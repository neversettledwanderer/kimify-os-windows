---
description: Design and document a auction planning with structured process, quality checks, and system integration
---
...
Design and document a comprehensive auction planning that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing auction planning documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the auction planning
...
- Structure the auction planning using the output format below
