---
description: Create a conflict of interest with structured process, quality checks, and system integration
---
...
Create a comprehensive conflict of interest that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing conflict of interest documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the conflict of interest
...
- Structure the conflict of interest using the output format below
