---
description: Create a storytelling nonprofit with structured process, quality checks, and system integration
---
...
Create a comprehensive storytelling nonprofit that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing storytelling nonprofit documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the storytelling nonprofit
...
- Structure the storytelling nonprofit using the output format below
