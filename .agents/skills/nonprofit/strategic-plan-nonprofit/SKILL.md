---
description: Design and document a strategic plan nonprofit with structured process, quality checks, and system integration
---

# Strategic Plan Nonprofit

## Purpose

Design and document a comprehensive strategic plan nonprofit that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing strategic plan nonprofit documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the strategic plan nonprofit
...
- Structure the strategic plan nonprofit using the output format below
