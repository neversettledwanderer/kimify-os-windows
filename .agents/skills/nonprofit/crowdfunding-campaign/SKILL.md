---
description: Design and document a crowdfunding campaign with structured process, quality checks, and system integration
---
...
Design and document a comprehensive crowdfunding campaign that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing crowdfunding campaign documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the crowdfunding campaign
...
- Structure the crowdfunding campaign using the output format below
