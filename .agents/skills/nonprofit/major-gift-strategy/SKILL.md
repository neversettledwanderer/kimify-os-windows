---
description: Design and document a major gift strategy with structured process, quality checks, and system integration
---
...
Design and document a comprehensive major gift strategy that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing major gift strategy documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the major gift strategy
...
- Structure the major gift strategy using the output format below
