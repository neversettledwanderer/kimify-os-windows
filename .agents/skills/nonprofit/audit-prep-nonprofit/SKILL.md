---
description: Analyze and produce a audit prep nonprofit with structured process, quality checks, and system integration
---

# Audit Prep Nonprofit

## Purpose

Analyze and produce a comprehensive audit prep nonprofit that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing audit prep nonprofit documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the audit prep nonprofit
...
- Structure the audit prep nonprofit using the output format below
