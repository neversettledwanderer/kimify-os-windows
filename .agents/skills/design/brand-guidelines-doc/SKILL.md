...
Design and document a comprehensive brand guidelines doc that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing brand guidelines doc documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the brand guidelines doc
...
- Structure the brand guidelines doc using the output format below
