...
Create a comprehensive photo direction brief that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing photo direction brief documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the photo direction brief
...
- Structure the photo direction brief using the output format below
