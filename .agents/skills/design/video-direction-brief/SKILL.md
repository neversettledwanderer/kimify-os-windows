...
Create a comprehensive video direction brief that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing video direction brief documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the video direction brief
...
- Structure the video direction brief using the output format below
