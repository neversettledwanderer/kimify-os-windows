...
Create a comprehensive information architecture that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing information architecture documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the information architecture
...
- Structure the information architecture using the output format below
