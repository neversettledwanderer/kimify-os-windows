...
Design and document a comprehensive creative campaign concept that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing creative campaign concept documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the creative campaign concept
...
- Structure the creative campaign concept using the output format below
