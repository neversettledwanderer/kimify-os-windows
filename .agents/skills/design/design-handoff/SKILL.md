...
Create a comprehensive design handoff that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing design handoff documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the design handoff
...
- Structure the design handoff using the output format below
