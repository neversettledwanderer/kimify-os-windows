...
Create a comprehensive design sprint that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing design sprint documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the design sprint
...
- Structure the design sprint using the output format below
