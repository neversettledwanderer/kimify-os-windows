...
Create a comprehensive packaging design brief that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing packaging design brief documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the packaging design brief
...
- Structure the packaging design brief using the output format below
