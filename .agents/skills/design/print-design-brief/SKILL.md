...
Create a comprehensive print design brief that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing print design brief documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the print design brief
...
- Structure the print design brief using the output format below
