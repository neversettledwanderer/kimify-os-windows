...
Analyze and produce a comprehensive wcag audit that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing wcag audit documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the wcag audit
...
- Structure the wcag audit using the output format below
