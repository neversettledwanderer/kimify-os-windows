...
Design and document a comprehensive data visualization guide that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing data visualization guide documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the data visualization guide
...
- Structure the data visualization guide using the output format below
