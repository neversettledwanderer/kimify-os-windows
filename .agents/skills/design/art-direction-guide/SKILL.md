...
Design and document a comprehensive art direction guide that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing art direction guide documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the art direction guide
...
- Structure the art direction guide using the output format below
