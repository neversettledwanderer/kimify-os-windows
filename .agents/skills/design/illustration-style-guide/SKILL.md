...
Design and document a comprehensive illustration style guide that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing illustration style guide documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the illustration style guide
...
- Structure the illustration style guide using the output format below
