...
Create a comprehensive accessibility design guide that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing accessibility design guide documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the accessibility design guide
...
- Structure the accessibility design guide using the output format below
