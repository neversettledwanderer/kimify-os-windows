---
description: Analyze and produce a support metrics dashboard with structured process, quality checks, and system integration
---
...
Analyze and produce a comprehensive support metrics dashboard that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing support metrics dashboard documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the support metrics dashboard
...
- Structure the support metrics dashboard using the output format below
