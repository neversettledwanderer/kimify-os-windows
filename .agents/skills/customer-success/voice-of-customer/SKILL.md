---
description: Create a voice of customer with structured process, quality checks, and system integration
---
...
Create a comprehensive voice of customer that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing voice of customer documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the voice of customer
...
- Structure the voice of customer using the output format below
