---
description: Create a support team training with structured process, quality checks, and system integration
---
...
Create a comprehensive support team training that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing support team training documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the support team training
...
- Structure the support team training using the output format below
