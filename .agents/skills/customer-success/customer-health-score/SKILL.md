---
description: Create a customer health score with structured process, quality checks, and system integration
---
...
Create a comprehensive customer health score that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing customer health score documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the customer health score
...
- Structure the customer health score using the output format below
