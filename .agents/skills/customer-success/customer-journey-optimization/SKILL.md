---
description: Create a customer journey optimization with structured process, quality checks, and system integration
---
...
Create a comprehensive customer journey optimization that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing customer journey optimization documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the customer journey optimization
...
- Structure the customer journey optimization using the output format below
