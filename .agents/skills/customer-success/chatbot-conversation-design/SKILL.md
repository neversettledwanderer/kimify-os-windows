---
description: Create a chatbot conversation design with structured process, quality checks, and system integration
---
...
Create a comprehensive chatbot conversation design that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing chatbot conversation design documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the chatbot conversation design
...
- Structure the chatbot conversation design using the output format below
