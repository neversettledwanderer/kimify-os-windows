---
description: Create a customer feedback loop with structured process, quality checks, and system integration
---
...
Create a comprehensive customer feedback loop that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing customer feedback loop documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the customer feedback loop
...
- Structure the customer feedback loop using the output format below
