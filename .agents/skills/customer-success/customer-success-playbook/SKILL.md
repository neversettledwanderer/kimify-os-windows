---
description: Design and document a customer success playbook with structured process, quality checks, and system integration
---
...
Design and document a comprehensive customer success playbook that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing customer success playbook documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the customer success playbook
...
- Structure the customer success playbook using the output format below
