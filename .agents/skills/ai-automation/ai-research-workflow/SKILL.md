...
Design and document a comprehensive ai research workflow that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing ai research workflow documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the ai research workflow
...
- Structure the ai research workflow using the output format below
