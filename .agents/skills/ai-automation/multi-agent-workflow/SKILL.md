...
Design and document a comprehensive multi agent workflow that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing multi agent workflow documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the multi agent workflow
...
- Structure the multi agent workflow using the output format below
