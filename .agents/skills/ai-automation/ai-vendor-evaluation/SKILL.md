...
Analyze and produce a comprehensive ai vendor evaluation that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing ai vendor evaluation documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the ai vendor evaluation
...
- Structure the ai vendor evaluation using the output format below
