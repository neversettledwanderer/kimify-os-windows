...
Analyze and produce a comprehensive ai readiness assessment that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing ai readiness assessment documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the ai readiness assessment
...
- Structure the ai readiness assessment using the output format below
