...
Create a comprehensive automation roi calculator that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing automation roi calculator documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the automation roi calculator
...
- Structure the automation roi calculator using the output format below
