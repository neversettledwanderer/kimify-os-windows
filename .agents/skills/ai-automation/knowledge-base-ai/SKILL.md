...
Create a comprehensive knowledge base ai that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing knowledge base ai documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the knowledge base ai
...
- Structure the knowledge base ai using the output format below
