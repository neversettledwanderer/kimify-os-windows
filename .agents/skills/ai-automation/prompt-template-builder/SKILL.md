...
Create a comprehensive prompt template builder that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing prompt template builder documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the prompt template builder
...
- Structure the prompt template builder using the output format below
