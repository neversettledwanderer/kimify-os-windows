...
Create a comprehensive ai email drafting that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing ai email drafting documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the ai email drafting
...
- Structure the ai email drafting using the output format below
