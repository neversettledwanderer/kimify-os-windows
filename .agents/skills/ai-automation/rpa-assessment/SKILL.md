...
Analyze and produce a comprehensive rpa assessment that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing rpa assessment documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the rpa assessment
...
- Structure the rpa assessment using the output format below
