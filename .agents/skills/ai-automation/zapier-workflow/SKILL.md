...
Design and document a comprehensive zapier workflow that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing zapier workflow documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the zapier workflow
...
- Structure the zapier workflow using the output format below
