...
Create a comprehensive intelligent automation that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing intelligent automation documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the intelligent automation
...
- Structure the intelligent automation using the output format below
