...
Analyze and produce a comprehensive deduction tracker that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing deduction tracker documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the deduction tracker
...
- Structure the deduction tracker using the output format below
