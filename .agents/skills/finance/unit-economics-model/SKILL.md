...
Design and document a comprehensive unit economics model that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing unit economics model documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the unit economics model
...
- Structure the unit economics model using the output format below
