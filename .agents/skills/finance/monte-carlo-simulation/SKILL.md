...
Create a comprehensive monte carlo simulation that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing monte carlo simulation documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the monte carlo simulation
...
- Structure the monte carlo simulation using the output format below
