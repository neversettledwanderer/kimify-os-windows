...
Analyze and produce a comprehensive term sheet analysis that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing term sheet analysis documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the term sheet analysis
...
- Structure the term sheet analysis using the output format below
