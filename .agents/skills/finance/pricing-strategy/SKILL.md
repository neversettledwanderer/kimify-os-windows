...
Design and document a comprehensive pricing strategy that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing pricing strategy documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the pricing strategy
...
- Structure the pricing strategy using the output format below
