...
Design and document a comprehensive cost reduction plan that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing cost reduction plan documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the cost reduction plan
...
- Structure the cost reduction plan using the output format below
