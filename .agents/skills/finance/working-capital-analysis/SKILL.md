...
Analyze and produce a comprehensive working capital analysis that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing working capital analysis documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the working capital analysis
...
- Structure the working capital analysis using the output format below
