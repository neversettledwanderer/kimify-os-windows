...
Create a comprehensive profit loss statement that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing profit loss statement documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the profit loss statement
...
- Structure the profit loss statement using the output format below
