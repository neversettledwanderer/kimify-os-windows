...
Analyze and produce a comprehensive financial ratio analysis that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing financial ratio analysis documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the financial ratio analysis
...
- Structure the financial ratio analysis using the output format below
