...
Analyze and produce a comprehensive expense report template that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing expense report template documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the expense report template
...
- Structure the expense report template using the output format below
