...
Analyze and produce a comprehensive compensation benchmarking that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing compensation benchmarking documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the compensation benchmarking
...
- Structure the compensation benchmarking using the output format below
