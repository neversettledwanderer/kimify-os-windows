...
Analyze and produce a comprehensive cost benefit analysis that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing cost benefit analysis documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the cost benefit analysis
...
- Structure the cost benefit analysis using the output format below
