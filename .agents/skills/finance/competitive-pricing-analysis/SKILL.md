...
Analyze and produce a comprehensive competitive pricing analysis that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing competitive pricing analysis documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the competitive pricing analysis
...
- Structure the competitive pricing analysis using the output format below
