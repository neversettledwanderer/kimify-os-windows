...
Analyze and produce a comprehensive price sensitivity analysis that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing price sensitivity analysis documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the price sensitivity analysis
...
- Structure the price sensitivity analysis using the output format below
