...
Design and document a comprehensive deferred revenue schedule that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing deferred revenue schedule documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the deferred revenue schedule
...
- Structure the deferred revenue schedule using the output format below
