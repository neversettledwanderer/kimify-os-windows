...
Analyze and produce a comprehensive financial audit prep that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing financial audit prep documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the financial audit prep
...
- Structure the financial audit prep using the output format below
