...
Analyze and produce a comprehensive kpi scorecard that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing kpi scorecard documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the kpi scorecard
...
- Structure the kpi scorecard using the output format below
