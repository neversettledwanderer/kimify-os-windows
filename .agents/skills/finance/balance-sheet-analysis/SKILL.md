...
Analyze and produce a comprehensive balance sheet analysis that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing balance sheet analysis documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the balance sheet analysis
...
- Structure the balance sheet analysis using the output format below
