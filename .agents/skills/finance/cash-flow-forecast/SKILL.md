...
Analyze and produce a comprehensive cash flow forecast that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing cash flow forecast documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Structure the cash flow forecast using the output format below
