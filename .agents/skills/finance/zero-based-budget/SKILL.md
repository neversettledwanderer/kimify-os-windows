...
Create a comprehensive zero based budget that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing zero based budget documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the zero based budget
...
- Structure the zero based budget using the output format below
