...
Design and document a comprehensive fundraising financial model that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing fundraising financial model documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Structure the fundraising financial model using the output format below
