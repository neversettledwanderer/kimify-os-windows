...
Create a comprehensive acquisition due diligence that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing acquisition due diligence documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the acquisition due diligence
...
- Structure the acquisition due diligence using the output format below
