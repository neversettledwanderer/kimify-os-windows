...
Create a comprehensive quarterly tax prep that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing quarterly tax prep documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the quarterly tax prep
...
- Structure the quarterly tax prep using the output format below
