---
description: Create a customer feedback restaurant with structured process, quality checks, and system integration
---
...
Create a comprehensive customer feedback restaurant that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing customer feedback restaurant documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the customer feedback restaurant
...
- Structure the customer feedback restaurant using the output format below
