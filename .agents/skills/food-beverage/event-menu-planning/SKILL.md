---
description: Design and document a event menu planning with structured process, quality checks, and system integration
---
...
Design and document a comprehensive event menu planning that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing event menu planning documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the event menu planning
...
- Structure the event menu planning using the output format below
