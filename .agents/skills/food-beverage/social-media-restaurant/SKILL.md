---
description: Create a social media restaurant with structured process, quality checks, and system integration
---
...
Create a comprehensive social media restaurant that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing social media restaurant documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the social media restaurant
...
- Structure the social media restaurant using the output format below
