---
description: Create a data warehouse schema with structured process, quality checks, and system integration
---
...
Create a comprehensive data warehouse schema that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing data warehouse schema documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the data warehouse schema
...
- Structure the data warehouse schema using the output format below
