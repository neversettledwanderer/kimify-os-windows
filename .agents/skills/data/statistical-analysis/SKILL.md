---
description: Analyze and produce a statistical analysis with structured process, quality checks, and system integration
---
...
Analyze and produce a comprehensive statistical analysis that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing statistical analysis documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the statistical analysis
...
- Structure the statistical analysis using the output format below
