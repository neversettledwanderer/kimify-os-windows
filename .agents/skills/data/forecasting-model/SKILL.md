---
description: Analyze and produce a forecasting model with structured process, quality checks, and system integration
---
...
Analyze and produce a comprehensive forecasting model that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing forecasting model documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the forecasting model
...
- Structure the forecasting model using the output format below
