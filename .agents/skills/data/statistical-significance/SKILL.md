---
description: Create a statistical significance with structured process, quality checks, and system integration
---
...
Create a comprehensive statistical significance that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing statistical significance documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the statistical significance
...
- Structure the statistical significance using the output format below
