---
description: Analyze and produce a kpi dashboard with structured process, quality checks, and system integration
---
...
Analyze and produce a comprehensive kpi dashboard that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing kpi dashboard documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the kpi dashboard
...
- Structure the kpi dashboard using the output format below
