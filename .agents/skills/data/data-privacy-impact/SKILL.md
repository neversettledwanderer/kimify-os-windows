---
description: Create a data privacy impact with structured process, quality checks, and system integration
---
...
Create a comprehensive data privacy impact that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing data privacy impact documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the data privacy impact
...
- Structure the data privacy impact using the output format below
