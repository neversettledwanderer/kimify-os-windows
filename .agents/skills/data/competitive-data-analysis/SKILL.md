---
description: Analyze and produce a competitive data analysis with structured process, quality checks, and system integration
---
...
Analyze and produce a comprehensive competitive data analysis that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing competitive data analysis documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the competitive data analysis
...
- Structure the competitive data analysis using the output format below
