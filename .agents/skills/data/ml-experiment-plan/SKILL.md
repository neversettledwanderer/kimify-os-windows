---
description: Design and document a ml experiment plan with structured process, quality checks, and system integration
---
...
Design and document a comprehensive ml experiment plan that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing ml experiment plan documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the ml experiment plan
...
- Structure the ml experiment plan using the output format below
