---
description: Analyze and produce a trend analysis with structured process, quality checks, and system integration
---
...
Analyze and produce a comprehensive trend analysis that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing trend analysis documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the trend analysis
...
- Structure the trend analysis using the output format below
