...
Design and document a comprehensive alerting strategy that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing alerting strategy documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the alerting strategy
...
- Structure the alerting strategy using the output format below
