...
Create a comprehensive circuit breaker pattern that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing circuit breaker pattern documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the circuit breaker pattern
...
- Structure the circuit breaker pattern using the output format below
