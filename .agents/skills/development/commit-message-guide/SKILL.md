...
Design and document a comprehensive commit message guide that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing commit message guide documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the commit message guide
...
- Structure the commit message guide using the output format below
