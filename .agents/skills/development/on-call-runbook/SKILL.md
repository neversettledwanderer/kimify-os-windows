...
Create a comprehensive on call runbook that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing on call runbook documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the on call runbook
...
- Structure the on call runbook using the output format below
