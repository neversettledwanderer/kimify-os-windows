...
Analyze and produce a comprehensive deployment checklist that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing deployment checklist documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the deployment checklist
...
- Structure the deployment checklist using the output format below
