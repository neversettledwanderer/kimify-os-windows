...
Analyze and produce a comprehensive root cause analysis that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing root cause analysis documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the root cause analysis
...
- Structure the root cause analysis using the output format below
