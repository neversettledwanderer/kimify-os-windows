...
Analyze and produce a comprehensive open source checklist that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing open source checklist documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the open source checklist
...
- Structure the open source checklist using the output format below
