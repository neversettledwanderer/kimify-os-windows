...
Create a comprehensive architecture decision record that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing architecture decision record documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the architecture decision record
...
- Structure the architecture decision record using the output format below
