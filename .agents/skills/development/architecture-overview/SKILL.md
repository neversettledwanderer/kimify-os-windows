...
Create a comprehensive architecture overview that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing architecture overview documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the architecture overview
...
- Structure the architecture overview using the output format below
