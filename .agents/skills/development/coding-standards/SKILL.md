...
Create a comprehensive coding standards that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing coding standards documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the coding standards
...
- Structure the coding standards using the output format below
