...
Analyze and produce a comprehensive monitoring setup that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing monitoring setup documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the monitoring setup
...
- Structure the monitoring setup using the output format below
