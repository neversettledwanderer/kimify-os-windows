...
Create a comprehensive supply chain security that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing supply chain security documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the supply chain security
...
- Structure the supply chain security using the output format below
