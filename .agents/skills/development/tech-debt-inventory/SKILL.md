...
Create a comprehensive tech debt inventory that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing tech debt inventory documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the tech debt inventory
...
- Structure the tech debt inventory using the output format below
