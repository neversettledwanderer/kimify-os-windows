...
Create a comprehensive event driven architecture that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing event driven architecture documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the event driven architecture
...
- Structure the event driven architecture using the output format below
