...
Create a comprehensive distributed tracing that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing distributed tracing documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the distributed tracing
...
- Structure the distributed tracing using the output format below
