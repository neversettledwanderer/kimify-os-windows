...
Create a comprehensive codebase walkthrough that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing codebase walkthrough documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the codebase walkthrough
...
- Structure the codebase walkthrough using the output format below
