...
Design and document a comprehensive api versioning strategy that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing api versioning strategy documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the api versioning strategy
...
- Structure the api versioning strategy using the output format below
