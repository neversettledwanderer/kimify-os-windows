...
Design and document a comprehensive e2e test strategy that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing e2e test strategy documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the e2e test strategy
...
- Structure the e2e test strategy using the output format below
