...
Analyze and produce a comprehensive accessibility audit that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing accessibility audit documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the accessibility audit
...
- Structure the accessibility audit using the output format below
