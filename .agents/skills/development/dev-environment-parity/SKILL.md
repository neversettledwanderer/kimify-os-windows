...
Create a comprehensive dev environment parity that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing dev environment parity documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the dev environment parity
...
- Structure the dev environment parity using the output format below
