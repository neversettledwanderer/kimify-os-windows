...
Create a comprehensive developer onboarding that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing developer onboarding documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the developer onboarding
...
- Structure the developer onboarding using the output format below
