---
description: Design and document a adventure travel plan with structured process, quality checks, and system integration
---
...
Design and document a comprehensive adventure travel plan that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing adventure travel plan documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the adventure travel plan
...
- Structure the adventure travel plan using the output format below
