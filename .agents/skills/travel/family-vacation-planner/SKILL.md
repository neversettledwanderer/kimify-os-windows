---
description: Design and document a family vacation planner with structured process, quality checks, and system integration
---
...
Design and document a comprehensive family vacation planner that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing family vacation planner documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the family vacation planner
...
- Structure the family vacation planner using the output format below
