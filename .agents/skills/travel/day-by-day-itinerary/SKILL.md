---
description: Create a day by day itinerary with structured process, quality checks, and system integration
---
...
Create a comprehensive day by day itinerary that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing day by day itinerary documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the day by day itinerary
...
- Structure the day by day itinerary using the output format below
