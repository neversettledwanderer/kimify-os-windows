---
description: Create a travel budget calculator with structured process, quality checks, and system integration
---
...
Create a comprehensive travel budget calculator that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing travel budget calculator documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the travel budget calculator
...
- Structure the travel budget calculator using the output format below
