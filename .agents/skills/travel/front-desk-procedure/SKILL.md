---
description: Create a front desk procedure with structured process, quality checks, and system integration
---
...
Create a comprehensive front desk procedure that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing front desk procedure documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the front desk procedure
...
- Structure the front desk procedure using the output format below
