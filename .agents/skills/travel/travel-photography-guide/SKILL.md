---
description: Design and document a travel photography guide with structured process, quality checks, and system integration
---
...
Design and document a comprehensive travel photography guide that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing travel photography guide documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the travel photography guide
...
- Structure the travel photography guide using the output format below
