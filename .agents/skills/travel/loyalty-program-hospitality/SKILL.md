---
description: Design and document a loyalty program hospitality with structured process, quality checks, and system integration
---

# Loyalty Program Hospitality

## Purpose

Design and document a comprehensive loyalty program hospitality that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing loyalty program hospitality documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the loyalty program hospitality
...
- Structure the loyalty program hospitality using the output format below
