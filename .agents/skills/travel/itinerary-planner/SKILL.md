---
description: Design and document a itinerary planner with structured process, quality checks, and system integration
---
...
Design and document a comprehensive itinerary planner that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing itinerary planner documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the itinerary planner
...
- Structure the itinerary planner using the output format below
