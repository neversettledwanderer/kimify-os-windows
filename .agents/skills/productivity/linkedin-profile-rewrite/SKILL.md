...
Create a comprehensive linkedin profile rewrite that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing linkedin profile rewrite documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the linkedin profile rewrite
...
- Structure the linkedin profile rewrite using the output format below
