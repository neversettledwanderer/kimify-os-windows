...
Create a comprehensive task decomposition that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing task decomposition documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the task decomposition
...
- Structure the task decomposition using the output format below
