...
Create a comprehensive meeting optimizer that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing meeting optimizer documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the meeting optimizer
...
- Structure the meeting optimizer using the output format below
