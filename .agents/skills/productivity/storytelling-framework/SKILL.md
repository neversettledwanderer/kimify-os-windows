...
Design and document a comprehensive storytelling framework that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing storytelling framework documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the storytelling framework
...
- Structure the storytelling framework using the output format below
