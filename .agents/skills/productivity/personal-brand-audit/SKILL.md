...
Analyze and produce a comprehensive personal brand audit that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing personal brand audit documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the personal brand audit
...
- Structure the personal brand audit using the output format below
