...
Create a comprehensive time blocking that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing time blocking documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the time blocking
...
- Structure the time blocking using the output format below
