...
Create a comprehensive virtual assistant brief that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing virtual assistant brief documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the virtual assistant brief
...
- Structure the virtual assistant brief using the output format below
