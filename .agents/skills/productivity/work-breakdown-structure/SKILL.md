...
Create a comprehensive work breakdown structure that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing work breakdown structure documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the work breakdown structure
...
- Structure the work breakdown structure using the output format below
