...
Analyze and produce a comprehensive outsourcing evaluation that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing outsourcing evaluation documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the outsourcing evaluation
...
- Structure the outsourcing evaluation using the output format below
