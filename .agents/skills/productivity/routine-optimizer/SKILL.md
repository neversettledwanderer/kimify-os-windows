...
Create a comprehensive routine optimizer that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing routine optimizer documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the routine optimizer
...
- Structure the routine optimizer using the output format below
