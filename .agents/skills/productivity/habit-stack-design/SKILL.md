...
Create a comprehensive habit stack design that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing habit stack design documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the habit stack design
...
- Structure the habit stack design using the output format below
