...
Create a comprehensive deep work blocks that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing deep work blocks documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the deep work blocks
...
- Structure the deep work blocks using the output format below
