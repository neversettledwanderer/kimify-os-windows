...
Create a comprehensive freelance proposal that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing freelance proposal documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the freelance proposal
...
- Structure the freelance proposal using the output format below
