...
Create a comprehensive quarterly goals that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing quarterly goals documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the quarterly goals
...
- Structure the quarterly goals using the output format below
