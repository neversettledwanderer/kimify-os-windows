...
Create a comprehensive annual goals that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing annual goals documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the annual goals
...
- Structure the annual goals using the output format below
