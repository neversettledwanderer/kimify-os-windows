...
Create a comprehensive public speaking prep that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing public speaking prep documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the public speaking prep
...
- Structure the public speaking prep using the output format below
