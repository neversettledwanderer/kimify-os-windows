...
Analyze and produce a comprehensive habit tracker that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing habit tracker documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the habit tracker
...
- Structure the habit tracker using the output format below
