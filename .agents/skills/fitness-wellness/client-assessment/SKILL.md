---
description: Analyze and produce a client assessment with structured process, quality checks, and system integration
---
...
Analyze and produce a comprehensive client assessment that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing client assessment documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the client assessment
...
- Structure the client assessment using the output format below
