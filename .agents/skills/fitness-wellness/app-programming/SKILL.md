---
description: Design and document a app programming with structured process, quality checks, and system integration
---
...
Design and document a comprehensive app programming that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing app programming documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the app programming
...
- Structure the app programming using the output format below
