---
description: Create a breathwork session with structured process, quality checks, and system integration
---
...
Create a comprehensive breathwork session that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing breathwork session documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the breathwork session
...
- Structure the breathwork session using the output format below
