---
description: Design and document a habit change program with structured process, quality checks, and system integration
---
...
Design and document a comprehensive habit change program that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing habit change program documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the habit change program
...
- Structure the habit change program using the output format below
