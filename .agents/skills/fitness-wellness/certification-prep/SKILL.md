---
description: Create a certification prep with structured process, quality checks, and system integration
---
...
Create a comprehensive certification prep that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing certification prep documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the certification prep
...
- Structure the certification prep using the output format below
