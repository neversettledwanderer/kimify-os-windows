---
description: Create a client retention fitness with structured process, quality checks, and system integration
---
...
Create a comprehensive client retention fitness that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing client retention fitness documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the client retention fitness
...
- Structure the client retention fitness using the output format below
