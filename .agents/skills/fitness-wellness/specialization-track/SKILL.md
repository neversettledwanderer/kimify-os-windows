---
description: Create a specialization track with structured process, quality checks, and system integration
---
...
Create a comprehensive specialization track that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing specialization track documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the specialization track
...
- Structure the specialization track using the output format below
