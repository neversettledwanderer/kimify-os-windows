---
description: Create a stress management with structured process, quality checks, and system integration
---
...
Create a comprehensive stress management that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing stress management documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the stress management
...
- Structure the stress management using the output format below
