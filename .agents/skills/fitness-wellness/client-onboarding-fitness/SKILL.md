---
description: Create a client onboarding fitness with structured process, quality checks, and system integration
---

# Client Onboarding Fitness

## Purpose

Create a comprehensive client onboarding fitness that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing client onboarding fitness documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the client onboarding fitness
...
- Structure the client onboarding fitness using the output format below
