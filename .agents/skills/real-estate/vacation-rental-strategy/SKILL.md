---
description: Design and document a vacation rental strategy with structured process, quality checks, and system integration
---
...
Design and document a comprehensive vacation rental strategy that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing vacation rental strategy documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the vacation rental strategy
...
- Structure the vacation rental strategy using the output format below
