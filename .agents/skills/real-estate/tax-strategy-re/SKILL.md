---
description: Design and document a tax strategy re with structured process, quality checks, and system integration
---
...
Design and document a comprehensive tax strategy re that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing tax strategy re documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the tax strategy re
...
- Structure the tax strategy re using the output format below
