---
description: Create a tenant screening with structured process, quality checks, and system integration
---
...
Create a comprehensive tenant screening that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing tenant screening documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the tenant screening
...
- Structure the tenant screening using the output format below
