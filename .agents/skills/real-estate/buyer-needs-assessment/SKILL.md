---
description: Analyze and produce a buyer needs assessment with structured process, quality checks, and system integration
---
...
Analyze and produce a comprehensive buyer needs assessment that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing buyer needs assessment documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the buyer needs assessment
...
- Structure the buyer needs assessment using the output format below
