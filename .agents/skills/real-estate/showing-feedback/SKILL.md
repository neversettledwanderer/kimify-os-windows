---
description: Create a showing feedback with structured process, quality checks, and system integration
---
...
Create a comprehensive showing feedback that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing showing feedback documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the showing feedback
...
- Structure the showing feedback using the output format below
