---
description: Analyze and produce a comparative market analysis with structured process, quality checks, and system integration
---
...
Analyze and produce a comprehensive comparative market analysis that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing comparative market analysis documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the comparative market analysis
...
- Structure the comparative market analysis using the output format below
