---
description: Create a development feasibility with structured process, quality checks, and system integration
---
...
Create a comprehensive development feasibility that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing development feasibility documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the development feasibility
...
- Structure the development feasibility using the output format below
