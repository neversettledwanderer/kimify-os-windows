---
description: Create a market update newsletter with structured process, quality checks, and system integration
---
...
Create a comprehensive market update newsletter that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing market update newsletter documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the market update newsletter
...
- Structure the market update newsletter using the output format below
