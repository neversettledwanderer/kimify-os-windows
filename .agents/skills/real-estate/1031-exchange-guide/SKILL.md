---
description: Design and document a 1031 exchange guide with structured process, quality checks, and system integration
---
...
Design and document a comprehensive 1031 exchange guide that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing 1031 exchange guide documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the 1031 exchange guide
...
- Structure the 1031 exchange guide using the output format below
