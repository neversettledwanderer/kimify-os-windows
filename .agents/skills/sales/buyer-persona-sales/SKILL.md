...
Create a comprehensive buyer persona sales that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing buyer persona sales documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the buyer persona sales
...
- Structure the buyer persona sales using the output format below
