...
Create a comprehensive cold linkedin message that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing cold linkedin message documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the cold linkedin message
...
- Structure the cold linkedin message using the output format below
