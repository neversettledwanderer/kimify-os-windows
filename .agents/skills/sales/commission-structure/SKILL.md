...
Create a comprehensive commission structure that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing commission structure documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the commission structure
...
- Structure the commission structure using the output format below
