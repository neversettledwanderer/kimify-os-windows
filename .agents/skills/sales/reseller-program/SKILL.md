...
Design and document a comprehensive reseller program that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing reseller program documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the reseller program
...
- Structure the reseller program using the output format below
