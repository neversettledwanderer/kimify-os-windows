...
Analyze and produce a comprehensive pipeline review that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing pipeline review documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the pipeline review
...
- Structure the pipeline review using the output format below
