...
Create a comprehensive sales meeting prep that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing sales meeting prep documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the sales meeting prep
...
- Structure the sales meeting prep using the output format below
