...
Analyze and produce a comprehensive strategic account review that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing strategic account review documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the strategic account review
...
- Structure the strategic account review using the output format below
