...
Design and document a comprehensive expansion revenue plan that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing expansion revenue plan documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the expansion revenue plan
...
- Structure the expansion revenue plan using the output format below
