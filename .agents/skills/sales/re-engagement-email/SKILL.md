...
Create a comprehensive re engagement email that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing re engagement email documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the re engagement email
...
- Structure the re engagement email using the output format below
