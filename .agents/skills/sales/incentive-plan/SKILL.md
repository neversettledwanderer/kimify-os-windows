...
Design and document a comprehensive incentive plan that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing incentive plan documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the incentive plan
...
- Structure the incentive plan using the output format below
