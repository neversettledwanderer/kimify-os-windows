...
Create a comprehensive role play scenario that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing role play scenario documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Structure the role play scenario using the output format below
