...
Analyze and produce a comprehensive win loss analysis that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing win loss analysis documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the win loss analysis
...
- Structure the win loss analysis using the output format below
