...
Design and document a comprehensive executive sponsor plan that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing executive sponsor plan documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the executive sponsor plan
...
- Structure the executive sponsor plan using the output format below
