...
Analyze and produce a comprehensive quarterly business review that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing quarterly business review documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the quarterly business review
...
- Structure the quarterly business review using the output format below
