...
Create a comprehensive onboarding sales rep that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing onboarding sales rep documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the onboarding sales rep
...
- Structure the onboarding sales rep using the output format below
