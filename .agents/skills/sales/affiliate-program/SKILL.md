...
Design and document a comprehensive affiliate program that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing affiliate program documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the affiliate program
...
- Structure the affiliate program using the output format below
