...
Create a comprehensive rfp response sales that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing rfp response sales documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the rfp response sales
...
- Structure the rfp response sales using the output format below
