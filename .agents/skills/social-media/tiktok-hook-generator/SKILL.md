...
Create a comprehensive tiktok hook generator that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing tiktok hook generator documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the tiktok hook generator
...
- Structure the tiktok hook generator using the output format below
