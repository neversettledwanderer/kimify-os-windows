...
Create a comprehensive tiktok script that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing tiktok script documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the tiktok script
...
- Structure the tiktok script using the output format below
