...
Design and document a comprehensive platform migration plan that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing platform migration plan documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the platform migration plan
...
- Structure the platform migration plan using the output format below
