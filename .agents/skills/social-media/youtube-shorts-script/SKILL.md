...
Create a comprehensive youtube shorts script that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing youtube shorts script documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the youtube shorts script
...
- Structure the youtube shorts script using the output format below
