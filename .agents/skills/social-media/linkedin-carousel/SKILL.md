...
Create a comprehensive linkedin carousel that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing linkedin carousel documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the linkedin carousel
...
- Structure the linkedin carousel using the output format below
