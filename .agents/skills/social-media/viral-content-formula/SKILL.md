...
Create a comprehensive viral content formula that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing viral content formula documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Structure the viral content formula using the output format below
