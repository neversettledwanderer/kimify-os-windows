...
Create a comprehensive instagram story sequence that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing instagram story sequence documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the instagram story sequence
...
- Structure the instagram story sequence using the output format below
