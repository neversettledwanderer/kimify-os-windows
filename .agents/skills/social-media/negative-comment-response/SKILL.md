...
Create a comprehensive negative comment response that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing negative comment response documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the negative comment response
...
- Structure the negative comment response using the output format below
