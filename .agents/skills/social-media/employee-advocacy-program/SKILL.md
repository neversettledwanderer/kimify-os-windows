...
Design and document a comprehensive employee advocacy program that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing employee advocacy program documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the employee advocacy program
...
- Structure the employee advocacy program using the output format below
