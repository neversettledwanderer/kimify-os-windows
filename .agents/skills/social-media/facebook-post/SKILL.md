...
Create a comprehensive facebook post that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing facebook post documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the facebook post
...
- Structure the facebook post using the output format below
