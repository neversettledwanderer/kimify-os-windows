...
Design and document a comprehensive brand ambassador program that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing brand ambassador program documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the brand ambassador program
...
- Structure the brand ambassador program using the output format below
