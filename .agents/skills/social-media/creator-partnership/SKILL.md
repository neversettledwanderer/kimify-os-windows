...
Create a comprehensive creator partnership that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing creator partnership documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the creator partnership
...
- Structure the creator partnership using the output format below
