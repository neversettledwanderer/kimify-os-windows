...
Analyze and produce a comprehensive tiktok trend analysis that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing tiktok trend analysis documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the tiktok trend analysis
...
- Structure the tiktok trend analysis using the output format below
