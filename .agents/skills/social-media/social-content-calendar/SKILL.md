...
Design and document a comprehensive social content calendar that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing social content calendar documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the social content calendar
...
- Structure the social content calendar using the output format below
