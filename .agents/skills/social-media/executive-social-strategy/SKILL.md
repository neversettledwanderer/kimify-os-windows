...
Design and document a comprehensive executive social strategy that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing executive social strategy documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the executive social strategy
...
- Structure the executive social strategy using the output format below
