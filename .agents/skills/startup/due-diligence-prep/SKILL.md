...
Create a comprehensive due diligence prep that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing due diligence prep documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the due diligence prep
...
- Structure the due diligence prep using the output format below
