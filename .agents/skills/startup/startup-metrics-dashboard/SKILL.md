...
Analyze and produce a comprehensive startup metrics dashboard that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing startup metrics dashboard documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the startup metrics dashboard
...
- Structure the startup metrics dashboard using the output format below
