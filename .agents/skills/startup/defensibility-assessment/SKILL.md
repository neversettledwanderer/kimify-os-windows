...
Analyze and produce a comprehensive defensibility assessment that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing defensibility assessment documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the defensibility assessment
...
- Structure the defensibility assessment using the output format below
