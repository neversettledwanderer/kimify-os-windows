...
Create a comprehensive build measure learn that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing build measure learn documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the build measure learn
...
- Structure the build measure learn using the output format below
