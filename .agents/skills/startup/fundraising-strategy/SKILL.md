...
Design and document a comprehensive fundraising strategy that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing fundraising strategy documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the fundraising strategy
...
- Structure the fundraising strategy using the output format below
