...
Create a comprehensive competitive landscape that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing competitive landscape documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the competitive landscape
...
- Structure the competitive landscape using the output format below
