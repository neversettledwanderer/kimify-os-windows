...
Create a comprehensive hiring first ten that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing hiring first ten documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the hiring first ten
...
- Structure the hiring first ten using the output format below
