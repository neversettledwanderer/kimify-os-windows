...
Design and document a comprehensive business model canvas that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing business model canvas documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the business model canvas
...
- Structure the business model canvas using the output format below
