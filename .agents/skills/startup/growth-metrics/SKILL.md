...
Analyze and produce a comprehensive growth metrics that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing growth metrics documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the growth metrics
...
- Structure the growth metrics using the output format below
