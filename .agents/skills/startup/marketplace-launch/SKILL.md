...
Create a comprehensive marketplace launch that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing marketplace launch documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the marketplace launch
...
- Structure the marketplace launch using the output format below
