...
Design and document a comprehensive advisory board setup that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing advisory board setup documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the advisory board setup
...
- Structure the advisory board setup using the output format below
