...
Analyze and produce a comprehensive retention analysis startup that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing retention analysis startup documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the retention analysis startup
...
- Structure the retention analysis startup using the output format below
