...
Analyze and produce a comprehensive startup legal checklist that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing startup legal checklist documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the startup legal checklist
...
- Structure the startup legal checklist using the output format below
