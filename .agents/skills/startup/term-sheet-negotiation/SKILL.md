...
Create a comprehensive term sheet negotiation that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing term sheet negotiation documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the term sheet negotiation
...
- Structure the term sheet negotiation using the output format below
