...
Design and document a comprehensive distribution strategy that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing distribution strategy documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the distribution strategy
...
- Structure the distribution strategy using the output format below
