---
description: Analyze and produce a employee certification tracker with structured process, quality checks, and system integration
---
...
Analyze and produce a comprehensive employee certification tracker that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing employee certification tracker documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the employee certification tracker
...
- Structure the employee certification tracker using the output format below
