---
description: Create a critical path with structured process, quality checks, and system integration
---
...
Create a comprehensive critical path that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing critical path documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the critical path
...
- Structure the critical path using the output format below
