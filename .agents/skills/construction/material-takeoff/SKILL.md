---
description: Create a material takeoff with structured process, quality checks, and system integration
---
...
Create a comprehensive material takeoff that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing material takeoff documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the material takeoff
...
- Structure the material takeoff using the output format below
