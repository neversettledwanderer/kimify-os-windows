---
description: Create a equipment maintenance with structured process, quality checks, and system integration
---
...
Create a comprehensive equipment maintenance that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing equipment maintenance documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the equipment maintenance
...
- Structure the equipment maintenance using the output format below
