---
description: Analyze and produce a progress report construction with structured process, quality checks, and system integration
---
...
Analyze and produce a comprehensive progress report construction that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing progress report construction documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the progress report construction
...
- Structure the progress report construction using the output format below
