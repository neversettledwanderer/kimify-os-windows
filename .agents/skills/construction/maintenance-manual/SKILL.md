---
description: Create a maintenance manual with structured process, quality checks, and system integration
---
...
Create a comprehensive maintenance manual that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing maintenance manual documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the maintenance manual
...
- Structure the maintenance manual using the output format below
