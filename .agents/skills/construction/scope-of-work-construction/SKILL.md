---
description: Create a scope of work construction with structured process, quality checks, and system integration
---
...
Create a comprehensive scope of work construction that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing scope of work construction documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the scope of work construction
...
- Structure the scope of work construction using the output format below
