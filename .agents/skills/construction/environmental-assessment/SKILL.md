---
description: Analyze and produce a environmental assessment with structured process, quality checks, and system integration
---
...
Analyze and produce a comprehensive environmental assessment that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing environmental assessment documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the environmental assessment
...
- Structure the environmental assessment using the output format below
