---
description: Create a quality control construction with structured process, quality checks, and system integration
---
...
Create a comprehensive quality control construction that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing quality control construction documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the quality control construction
...
- Structure the quality control construction using the output format below
