---
description: Create a subcontractor agreement with structured process, quality checks, and system integration
---
...
Create a comprehensive subcontractor agreement that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing subcontractor agreement documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the subcontractor agreement
...
- Structure the subcontractor agreement using the output format below
