---
description: Create a as built documentation with structured process, quality checks, and system integration
---
...
Create a comprehensive as built documentation that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing as built documentation documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the as built documentation
...
- Structure the as built documentation using the output format below
