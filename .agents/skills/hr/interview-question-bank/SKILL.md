---
description: Create a interview question bank with structured process, quality checks, and system integration
---
...
Create a comprehensive interview question bank that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing interview question bank documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the interview question bank
...
- Structure the interview question bank using the output format below
