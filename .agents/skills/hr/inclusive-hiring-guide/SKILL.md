---
description: Design and document a inclusive hiring guide with structured process, quality checks, and system integration
---
...
Design and document a comprehensive inclusive hiring guide that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing inclusive hiring guide documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the inclusive hiring guide
...
- Structure the inclusive hiring guide using the output format below
