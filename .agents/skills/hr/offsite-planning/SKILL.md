---
description: Design and document a offsite planning with structured process, quality checks, and system integration
---
...
Design and document a comprehensive offsite planning that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing offsite planning documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the offsite planning
...
- Structure the offsite planning using the output format below
