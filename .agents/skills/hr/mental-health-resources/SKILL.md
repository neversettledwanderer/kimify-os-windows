---
description: Create a mental health resources with structured process, quality checks, and system integration
---
...
Create a comprehensive mental health resources that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing mental health resources documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the mental health resources
...
- Structure the mental health resources using the output format below
