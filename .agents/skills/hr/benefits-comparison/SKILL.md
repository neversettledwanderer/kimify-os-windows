---
description: Analyze and produce a benefits comparison with structured process, quality checks, and system integration
---
...
Analyze and produce a comprehensive benefits comparison that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing benefits comparison documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the benefits comparison
...
- Structure the benefits comparison using the output format below
