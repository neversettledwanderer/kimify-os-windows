---
description: Create a employee engagement survey with structured process, quality checks, and system integration
---
...
Create a comprehensive employee engagement survey that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing employee engagement survey documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the employee engagement survey
...
- Structure the employee engagement survey using the output format below
