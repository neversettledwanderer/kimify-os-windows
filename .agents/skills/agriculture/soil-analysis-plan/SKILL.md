---
description: Analyze and produce a soil analysis plan with structured process, quality checks, and system integration
---
...
Analyze and produce a comprehensive soil analysis plan that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing soil analysis plan documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the soil analysis plan
...
- Structure the soil analysis plan using the output format below
