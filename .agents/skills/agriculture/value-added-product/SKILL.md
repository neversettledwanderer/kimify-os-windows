---
description: Create a value added product with structured process, quality checks, and system integration
---
...
Create a comprehensive value added product that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing value added product documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the value added product
...
- Structure the value added product using the output format below
