---
description: Create a wholesale channel with structured process, quality checks, and system integration
---
...
Create a comprehensive wholesale channel that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing wholesale channel documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the wholesale channel
...
- Structure the wholesale channel using the output format below
