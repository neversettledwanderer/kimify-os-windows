---
description: Design and document a succession planning farm with structured process, quality checks, and system integration
---
...
Design and document a comprehensive succession planning farm that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing succession planning farm documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the succession planning farm
...
- Structure the succession planning farm using the output format below
