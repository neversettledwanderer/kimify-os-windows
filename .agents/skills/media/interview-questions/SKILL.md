---
description: Create a interview questions with structured process, quality checks, and system integration
---
...
Create a comprehensive interview questions that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing interview questions documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the interview questions
...
- Structure the interview questions using the output format below
