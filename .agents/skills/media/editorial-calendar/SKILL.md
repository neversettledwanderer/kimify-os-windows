---
description: Design and document a editorial calendar with structured process, quality checks, and system integration
---
...
Design and document a comprehensive editorial calendar that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing editorial calendar documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the editorial calendar
...
- Structure the editorial calendar using the output format below
