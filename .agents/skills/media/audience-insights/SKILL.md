---
description: Create a audience insights with structured process, quality checks, and system integration
---
...
Create a comprehensive audience insights that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing audience insights documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the audience insights
...
- Structure the audience insights using the output format below
