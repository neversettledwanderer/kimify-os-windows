---
description: Create a sponsorship deck with structured process, quality checks, and system integration
---
...
Create a comprehensive sponsorship deck that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing sponsorship deck documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the sponsorship deck
...
- Structure the sponsorship deck using the output format below
