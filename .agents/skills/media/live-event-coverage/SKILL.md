---
description: Create a live event coverage with structured process, quality checks, and system integration
---
...
Create a comprehensive live event coverage that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing live event coverage documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the live event coverage
...
- Structure the live event coverage using the output format below
