---
description: Design and document a editorial guidelines with structured process, quality checks, and system integration
---
...
Design and document a comprehensive editorial guidelines that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing editorial guidelines documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the editorial guidelines
...
- Structure the editorial guidelines using the output format below
