---
description: Design and document a content strategy media with structured process, quality checks, and system integration
---
...
Design and document a comprehensive content strategy media that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing content strategy media documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the content strategy media
...
- Structure the content strategy media using the output format below
