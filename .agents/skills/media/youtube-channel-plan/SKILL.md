---
description: Design and document a youtube channel plan with structured process, quality checks, and system integration
---
...
Design and document a comprehensive youtube channel plan that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing youtube channel plan documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the youtube channel plan
...
- Structure the youtube channel plan using the output format below
