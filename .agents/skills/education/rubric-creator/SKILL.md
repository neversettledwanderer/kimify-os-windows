---
description: Create a rubric creator with structured process, quality checks, and system integration
---
...
Create a comprehensive rubric creator that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing rubric creator documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the rubric creator
...
- Structure the rubric creator using the output format below
