---
description: Create a scorm module spec with structured process, quality checks, and system integration
---
...
Create a comprehensive scorm module spec that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing scorm module spec documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the scorm module spec
...
- Structure the scorm module spec using the output format below
