---
description: Create a student feedback survey with structured process, quality checks, and system integration
---
...
Create a comprehensive student feedback survey that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing student feedback survey documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the student feedback survey
...
- Structure the student feedback survey using the output format below
