---
description: Create a leadership development with structured process, quality checks, and system integration
---
...
Create a comprehensive leadership development that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing leadership development documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the leadership development
...
- Structure the leadership development using the output format below
