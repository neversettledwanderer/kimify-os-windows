---
description: Analyze and produce a skills gap analysis with structured process, quality checks, and system integration
---
...
Analyze and produce a comprehensive skills gap analysis that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing skills gap analysis documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the skills gap analysis
...
- Structure the skills gap analysis using the output format below
