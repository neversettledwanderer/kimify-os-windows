---
description: Create a workshop materials with structured process, quality checks, and system integration
---
...
Create a comprehensive workshop materials that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing workshop materials documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the workshop materials
...
- Structure the workshop materials using the output format below
