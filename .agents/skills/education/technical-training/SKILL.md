---
description: Create a technical training with structured process, quality checks, and system integration
---
...
Create a comprehensive technical training that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing technical training documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the technical training
...
- Structure the technical training using the output format below
