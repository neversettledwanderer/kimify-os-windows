---
description: Create a learning objectives with structured process, quality checks, and system integration
---
...
Create a comprehensive learning objectives that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing learning objectives documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the learning objectives
...
- Structure the learning objectives using the output format below
