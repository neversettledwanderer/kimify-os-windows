---
description: Create a responsibility assignment with structured process, quality checks, and system integration
---
...
Create a comprehensive responsibility assignment that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing responsibility assignment documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the responsibility assignment
...
- Structure the responsibility assignment using the output format below
