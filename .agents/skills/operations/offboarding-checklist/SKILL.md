---
description: Analyze and produce a offboarding checklist with structured process, quality checks, and system integration
---
...
Analyze and produce a comprehensive offboarding checklist that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing offboarding checklist documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the offboarding checklist
...
- Structure the offboarding checklist using the output format below
