---
description: Create a workflow design with structured process, quality checks, and system integration
---
...
Create a comprehensive workflow design that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing workflow design documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the workflow design
...
- Structure the workflow design using the output format below
