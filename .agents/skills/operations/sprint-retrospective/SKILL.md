---
description: Create a sprint retrospective with structured process, quality checks, and system integration
---
...
Create a comprehensive sprint retrospective that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing sprint retrospective documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the sprint retrospective
...
- Structure the sprint retrospective using the output format below
