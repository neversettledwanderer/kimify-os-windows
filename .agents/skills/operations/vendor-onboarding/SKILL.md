---
description: Create a vendor onboarding with structured process, quality checks, and system integration
---
...
Create a comprehensive vendor onboarding that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing vendor onboarding documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the vendor onboarding
...
- Structure the vendor onboarding using the output format below
