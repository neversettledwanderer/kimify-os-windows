---
description: Create a handover document with structured process, quality checks, and system integration
---
...
Create a comprehensive handover document that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing handover document documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the handover document
...
- Structure the handover document using the output format below
