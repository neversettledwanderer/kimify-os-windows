---
description: Design and document a change management plan with structured process, quality checks, and system integration
---
...
Design and document a comprehensive change management plan that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing change management plan documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the change management plan
...
- Structure the change management plan using the output format below
