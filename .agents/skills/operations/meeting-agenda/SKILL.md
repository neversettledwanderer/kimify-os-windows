---
description: Create a meeting agenda with structured process, quality checks, and system integration
---
...
Create a comprehensive meeting agenda that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing meeting agenda documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the meeting agenda
...
- Structure the meeting agenda using the output format below
