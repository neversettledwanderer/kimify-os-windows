---
description: Design and document a business continuity plan with structured process, quality checks, and system integration
---
...
Design and document a comprehensive business continuity plan that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing business continuity plan documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the business continuity plan
...
- Structure the business continuity plan using the output format below
