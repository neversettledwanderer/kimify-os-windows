---
description: Create a lessons learned with structured process, quality checks, and system integration
---
...
Create a comprehensive lessons learned that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing lessons learned documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the lessons learned
...
- Structure the lessons learned using the output format below
