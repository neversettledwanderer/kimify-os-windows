---
description: Analyze and produce a vendor scorecard with structured process, quality checks, and system integration
---
...
Analyze and produce a comprehensive vendor scorecard that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing vendor scorecard documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the vendor scorecard
...
- Structure the vendor scorecard using the output format below
